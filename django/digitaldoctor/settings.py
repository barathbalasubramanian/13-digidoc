"""
Django settings for digitaldoctor project.
...
SECRET_KEY = 'django-insecure-@s2+0hy#g7$+(v89kjl+i$5&q_6*f90n#^bpd+rv(f17dkw6-u'
...
INSTALLED_APPS = [
    ...
    'xraymodel.apps.XraymodelConfig',
    'crispy_forms',
]
...
WSGI_APPLICATION = 'digitaldoctor.wsgi.application'
